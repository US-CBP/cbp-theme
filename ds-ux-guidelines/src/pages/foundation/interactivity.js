  ...
  <Layout>
    ...
    <Tabs className="tabs--scroll">
      ...
      <article className="spacing-wrapper">
        ...
        <TabPanel>
          <section name="Research & References" id="Research & References">
            <h2 className="cbp-heading-2">Types of Interaction</h2>
            <p className="cbp-body">
              Interactivity in digital products manifests itself in many
              different ways. Essentially, anything on the page that accepts
              user input and then reacts, will fall under this category.
            </p>
            ...
            <p className="cbp-body">
              ...
              so they can confidently move on to the next task at hand. Read
              more on the Doherty Threshold here.
              {/* @TODO: insert anchor link here */}
            </p>

            <h4 className="cbp-heading-4">Calls to Action</h4>
            <p className="cbp-body">
              These are special instances of action items. They usually
              represent the main action on the page and are at the top of the
              hierarchical food chain. As such, they are usually styled somewhat
              differently than other like elements on the page, so as to pull
              extra visual attention to themselves. This might be a "buy" button
              on e-commerce site, a "submit" button on a form, or a "sign-up"
              button on a newsletter. When designing your layout, take a moment
              and think about what the main action on your page is. Can you find
              the action item very quickly without scanning the entire page? If
              not, think about how you can adjust your layout to make this more
              prominent. Be careful not to make it overwhelmingly different.
            </p>

            <h4 className="cbp-heading-4">Confirmation of Action</h4>
            <p className="cbp-body">
              Some actions have consequences that are so important that we might
              want to double check with the user that they are sure they made
              the right selection. Normally, this is reserved for actions that
              are destructive in nature. Meaning that once this action is taken,
              it likely cannot be taken back. Or, in situations where that
              action might have a significant business impact. Sometimes, this
              manifests itself as a confirmation modal, or a confirmation page,
              depending on its complexity.
            </p>

            <h3 className="cbp-heading-3">Forms</h3>
            <p className="cbp-body">
              These elements collect information from our users. Form fields
              allow users to enter custom input because we cannot accurately
              predict all of the possible entries a user might enter. There may
              be ways to assist users by making auto-fill suggestions once they
              begin entering information, such as when they start entering an
              address. If you have formatting requirements or other restrictions
              to the content (like character limits) be very explicit in your
              instructions to the user. All form elements should have a very
              clear label as to what piece of information it collecting. Home
              street address and business address can mean very different
              things. The answers you get are only as good as the questions you
              ask.
            </p>
            ...
            <p className="cbp-body">
              ...
              action. Sometimes these allow a user to make a single choice from
              a grouping like with a radio button or a toggle, or allow your
              users to build groupings like with check boxes, list items, or
              tags. There needs to be a clear distinction between which items
              are currently selected and which are not. Labels and instruction
              should be clear about what the consequence of the selection is,
              and what is required before an action is able to be taken, if
              applicable.
            </p>
            ...
            <p className="cbp-body">
              ...
              information organized in a way that makes sense. Navigation is
              about allowing your users to intuitively move between different
              pages within your application, and within different elements on
              those pages.
            </p>
            <p className="cbp-body">
            ...
            <div className="content">
              <ul>
                ...
                <li>
                  ...
                  application or site. Links featured inside page content may
                  also allow similar navigation, but should not be the primary
                  way to do so.
                </li>
                ...
                <li>
                  ...
                  button on something like a data table, etc. allows our users
                  to move between large sets of connected content within a
                  single page of an application or site.
                </li>
              </ul>
            </div>
            ...
            <p className="cbp-body">
              ...
              like turning on or off content, like a switch. You might filter
              the content by making selections on different categories of
              content to show or hide. Or sorting content by a measure like
              dates, quantity, or alphabetically. These actions should be
              non-destructive and allow the user to undo or change their
              decision. There needs to be sufficient visual cues about what type
              of manipulation is currently applied, as this will hint to the
              user they have some ability over how to change it.
            </p>
            ...
            <p className="cbp-body">
              ...
              (anchor links). Sometimes these lead to other parts of the same
              site or application. Links that lead to external sites or
              applications should be demarcated with iconography (specifically
              the{" "}
              <a href="https://fontawesome.com/icons/external-link">
                external link icon
              </a>
              ) letting the user know we are about to send them somewhere
              outside of the application or site they are currently in. As well
              as opening this type of link in a new tab. This will allow our
              users to have a reference back to where they were without hitting
              the browser's back button and help keep them from getting lost.
            </p>

            <h3 className="cbp-heading-3">Search</h3>
            <p className="cbp-body">
              Search is a complicated matter. It can act as navigation, a
              filtering mechanism, or as an escape hatch depending on where it
              is located within the layout. Search should be as flexible as
              possible, allowing in a wide range of inputs to help users find
              the information they need without getting stuck on formatting
              their query. For example, accounting for user input errors like
              spelling or punctuation variation, looking for synonyms, or not
              being dogmatic about character formatting of the search input.
            </p>
            ...
            <p className="cbp-body">
              ...
              being so dogmatic about word order, spelling, punctuation, or
              other formatting so that the user can find what they need instead
              of a set of results that don't match with their expectations.
              "Fuzzy" search is a good example of this where users can misspell
              words or enter synonyms to find what they need. Autofill can also
              assist users with finding what they need and proactively try to
              eliminate user-error before a search is executed.
            </p>

            <h4 className="cbp-heading-4">Search Placement</h4>
            <p className="cbp-body">
              Where the search bar is located is an important cue as to what
              information is being searched against. Placing the search bar in
              the application header gives the impression to the user that
              results will encompass anything on the site or application.
              Placing it in the content area of the page hints that results will
              be relegated to that specific pages' content. Placement and visual
              context let the user have a rough idea of the data set they will
              be searching against. Think carefully about where you will place
              your search functionality when crafting your layouts.
            </p>
            ...
            <p className="cbp-body">
              ...
              choices by the user. Normally, it's from something they have set
              up prior and now through the normal course of business they are
              sending input to the system. Wearables are a good example of this,
              where the simple act of walking, exercising, etc. sends data back
              to a system. Where appropriate, notifications or messaging should
              be clear about what input was received, and what actions the
              system is making on their behalf.
            </p>
            ...
            <p className="cbp-body">
              ...
              consequences. That's why having clear, intuitive design
              distinctions between elements that are informative, and those that
              are interactive is so important. A user should be readily able to
              distinguish which elements on the page are interactive, and what
              the consequences of those interactions are.
            </p>
            ...
            <p className="cbp-body">
              ...
              element is interactive, what its current state is, or that there
              is something wrong. Do not mix colors to match brands or create a
              unique environment just for your app. Just as with any other
              affordance, these ideas are only easily recalled by our users
              because they are repeatedly exposed to them in a consistent way.
              For our CBP enterprise users, the CBP Design System was not
              created to be "theme-able." We want all of our users to encounter
              the same set of rules for any app they may visit within the
              enterprise. The colors have been carefully chosen to meet
              accessibility standards, to match common understanding, and to
              allow users to quickly distinguish information. For more
              information on our color palette visit the{" "}
              <a href="colors">Colors section in Foundations here.</a>
            </p>
            ...
            <p className="cbp-body">
              ...
              are not). Applying a color overlay (a semi-transparent percentage
              of the color assigned to that particular state) on top of the
              surface can help reinforce the interaction and what its current
              state is. Only one of these overlays should be applied at a time.
              For instance, on an active element only display the hover overlay
              not the active one (provided it can actually be interacted with
              again). Overlays should be adjusted percentage wise to maintain
              accessibility depending on the particular color of the surface
              being applied to.
            </p>
            ...
            <p className="cbp-body">
              ...
              interaction the elements physically transform into different
              states. These states give users hints about what elements they can
              manipulate and what they can't. As well as what is likely to
              happen if the complete that transaction. Learn more about states
              in the
            ...
            <p className="cbp-body">
              Changing the color, weight, or styling of text can give users
              hints about what is interactive. On buttons, we change the font
              weight to medium as well as style it as All Caps. This is why All
              Caps should not be used on non-interactive content. For textual
              links inside large blocks of text, we change the color and
              underline the text to give users a hint to functionality. For more
              information about these treatments view this.
              {/* @TODO: add link here */}
            </p>

            <h3 className="cbp-heading-3">Adding Iconography</h3>
            <p className="cbp-body">
              Iconography can add a good visual anchor to pull a user's
              attention. This can be useful in establishing uniqueness. To learn
            ...
            <p className="cbp-body">
              Skeuomorphism is the bridge from the digital world and the
              physical world. When we apply this concept to interactive elements
              we attach meaning by styling an element like a similar, real-world
              object. Buttons that look and behave like a physical button you
              might find on a piece of electronics, dials that look like a knob
              you might see on a radio, or all of the iconographic choices we
              can make which give hints to functionality.
            </p>
            ...
            <p className="cbp-body">
              ...
              your users hints as to what is or is about to happen. Naturally
              with touch devices these will not appear.
            </p>
            <p className="cbp-body">
              You can set what cursor type you want the user to see when you
              change the cursor CSS property (hover over the title of each
              bullet point to see the corresponding cursor):
            </p>
            <div className="content">
              <ul>
                <li>
                ...
                <li>
                  ...
                  You would use this when the UI is allowing the user to
                  zoom-in, such as with a map.
                </li>
                ...
                <li>
                  ...
                  You would use this when the user's cursor is over an
                  interactive element which currently in the disabled state. NOT
                  in an off state.
                </li>
            ...
            <p className="cbp-body">
              ...
              state changes, or more complex to describe the importance or
              nature of the action being taken. A little goes a long way here.
              The purpose is to give visual feedback to the user that the system
              has received their input, not to decorate or entertain. To learn
              more about Motion and Animation, visit its page in Foundations
              here
            </p>
            {/* @TODO: add link here */}
            ...
            <p className="cbp-body">
              ...
              fingers are obscuring the view of the object we're trying to
              touch. How do we give appropriate feedback to our users that the
              system has accepted their input? Using sounds and vibrations
              (referred to as haptics) we can make sure that the system is
              giving timely feedback in this kind of environment. These
              attributes are still subject to standardized formatting, making
              sure we are giving a consistent experience. Actions that are
              positive or neutral in nature have a certain tone and vibration
              that is distinct from an action that might be destructive in
              nature like delete. While haptics may be only available on a
              select number of devices, UI sounds are generally applicable on
              all devices, provided it has a speaker. To learn more about UI
              Sounds and Haptics, view the section of Foundations here.
              {/* @TODO: add link here */}
            </p>
            ...
            <p className="cbp-body">
              ...
              function of the page. These will need different types of
              treatments to give the user cues about what level of importance an
              item has, and what content it is connected to.
            </p>

            <h3 className="cbp-heading-3">
              Proximity, Grouping, and Placement
            </h3>
            <p className="cbp-body">
              The way we style Interactive elements, where we place them, and
              other visual cues, let our users know what these elements can do
              and how they affect content on the page.
            </p>

            <h4 className="cbp-heading-4">
              Items that Share a Common Boundary are Associated Together-
            ...
            <h4 className="cbp-heading-4">
              Items that are Close Together are Asociated Together- Gestalt Law
              of Proximity
            </h4>
            <p className="cbp-body">
              ...
              themselves, the mind will perceive two groupings even if all of
              the cards are visually similar.
            </p>
            <p className="cbp-body">
              ...
              relationship. Putting the previous or next page controls for a
              data table completely separate from the data table doesn't make
              much sense.
            </p>
            <Image imgName="interactivity-gestaltProximity.png" />

            <h4 className="cbp-heading-4">
              Items that Look or Behave the Same are Associated Together -
              Gestalt Law of Similarity
            </h4>
            <p className="cbp-body">
              People have a tendency to view elements with similar
              characteristics like color, shape, size, orientation, and behavior
              as related. A row of similarly styled buttons would indicate that
              a user is being given a choice of a set of actions to take. And
              that each of these decisions is related to the same issue.
            </p>
            ...
            <p className="cbp-body">
              ...
              straight or curved, will be associated together. People's eyes
              tend to follow paths until they are interrupted.
            </p>
            ...
            <p className="cbp-body">
              ...
              This helps reinforce that this collection of information is
            ...
            <p className="cbp-body">
              ...
              bit of a combination of proximity and a few other concepts, but
              that alignment adds another layer of reinforcement.
            </p>
            ...
            <p className="cbp-body">
              ...
              relationship. Even altering the styling of that line can change
              the nature of the relationship. Be wary of connecting content that
              is not related with visual devices.
            </p>
            <Image
            ...
            <div className="content">
              <ul>
                <li>
                  ...
                  users will encounter an error by making the correct selection
                  on the first try. Smaller surface areas require a greater
                  level of dexterity and control. This obviously has a point of
                  diminishing returns where increasing the object's size no
                  longer produces any gains in productivity.
                </li>
                <Image imgName="interactivity-fittsLaw.jpg" />
                <li>
                  The shorter the distance between a user's task/attention area
                  and the corresponding task-related interactive element the
                  less time it takes for the user to realize they are connected
                  and that there are options available for them to consider. For
                  example, putting a previous/next page control for data table
                  in a completely different area than the table just doesn't
                  make sense. Drop down menus for instance, should only be used
                  under certain circumstances because they increase the distance
                  the user has to travel between where they first interacted
                  with the element and the subsequent selection.
                </li>
                <Image imgName="interactivity-fittsLaw2.jpg" />
                <li>
                  <strong>Time</strong> is the amount of time required to
                  complete the movement.
                </li>
                <li>
                  <strong>A and B</strong> are empirically determined regression
                  coefficients, which is basically a fancy way of stating they
                  are values gained from direct observation that build a slope.
                </li>
                <li>
            ...
            <p className="cbp-body">
              ...
              physical dimensions of what is clickable or tappable. Touch
              targets should be large enough for users to both discern what it
              is and to accurately select them. Our goal is at least 48px x 48px
              in size.
            </p>
            <p className="cbp-body">
              Touch targets should have ample spacing between each other. This
              can prevent accidental choices from being made, which slow down
              ...
              elements. The bigger the elements, the more space should be
            ...
            <p className="cbp-body">
              Fitt's Index is about the relationship with the physical
              interaction with a device, and the physical exertion taken on the
              human skeletal-muscular system by completing that interaction. If
              you are using a desktop system this might refer to the fatigue
              sustained by having to swing wildly back and forth to different
              areas of the screen, needing to know lots of hotkey commands, or
              other repetitive movements. With mobile this might refer to having
              the thumb often stretching to the top of the screen, which can be
              difficult when handling a device in a single hand. The most
              extreme example might be wall-mounted touch-screens, as pretty
              much all interaction with them can become tiring very quickly. The
              converse of this is making one-way or destructive interactions
              more difficult, so that they are not done accidentally. For
              example, turning off the mobile device by first having to hold the
              power button down then a sliding button to turn off completely.
              This keeps the user from accidentally completing this action.
            </p>
            ...
            <p className="cbp-body">
              ...
              have "infinite edges." The cursor automatically aligns or the
              user's touch is limited by the physical dimensions of the device.
              Either way, the edge is always easier to find.
            </p>
            ...
            <p className="cbp-body">
              ...
              have an important action on the page such as a submit on a form,
              it should be distinctive enough visually to let your user know
            ...
            <p className="cbp-body">
              ...
              cognitive load on your user because they haven't seen any other
              part of the list yet. As your user goes through the list and gets
              to the end though, because the last few items are in your recent
              memory they also put less cognitive load on your user.
              Unfortunately the stuff in the middle suffers, and more so as
              lists get longer. As such, important information should be
              emphasized on the ends of the lists.
            </p>
            ...
            <p className="cbp-body">
              ...
              required to process a new piece of information. Does this label
              make sense? Is this error message explaining what is actually
              wrong so I can fix it? Basically how much energy is consumed
              trying to understand what the user is supposed to do. This is why
              short, simple copy (micro copy) is so important and can be very
              effective at reducing cognitive load provided it gives all
              necessary instruction.
            </p>
            <p className="cbp-body">
              The more times a user is exposed to a piece of instruction the
              less cognitive load is required for them to understand it. This is
              why so many times we find users get used to bad experiences.
              Familiarity is often confused with success. This is also why users
              may be hesitant to change. It took them so long to get used to the
              first crappy experience they don't want to repeat it.
            </p>
            <Image imgName="interactivity-intristicCogLoad.png" size="700px" />

            <h3 className="cbp-heading-3">Extraneous Cognitive Load</h3>
            <p className="cbp-body">
              Extraneous cognitive load is directly related to how the
              information is designed, because it takes up mental space doesn't
              necessarily help users understand the content. Does the
              information have good hierarchy? Is it aesthetically pleasing?
              Does the way it is presented reinforce what the user is supposed
              to do, or does it get in the way? Good design can reduce overall
              cognitive load. The goal here is to simply make sure that design
              doesn't add unnecessary load to the user. The best you can do here
              is not add to the problem.
            </p>

            <h4 className="cbp-heading-4">Aesthetic Usability Effect</h4>
            <p className="cbp-body">
              Aesthetically pleasing designs can make minor usability issues
              more tolerable. They can mask these usability issues on early
              visits, but after each subsequent visit these issues become more
              and more apparent. This can complicate user testing in that a
              pretty site might only garner feedback in relation to the way it
              looks and not how it functions. Which is why it is important to
              continue doing research over time so this effect can wear off. A
              site can be pretty, but after struggling enough times to find what
              you need, that feedback will rise to the top.
            </p>
            ...
            <p className="cbp-body">
              ...
              to this other area of the site? Just like with intrinsic load,
              this wanes over time with repeated exposure. You should be careful
              about making significant changes to the navigation and
              organization of an application as it can increase the cognitive
              load of the user before they become accustomed to the new pattern.
            </p>
            ...
            <p className="cbp-body">
              Recognition is preferable because it involves more cues than
              recall for the user to understand the meaning of a piece of
              information or action. This helps reduce cognitive load on our
              users becuase they intuitively know what is expected of them. This
              is why mulitple choice drop downs can be more effective than an
              open text field. The user doesn't have to search their memory for
              the answer, but instead recognizes the correct choice quickly from
            ...
            <p className="cbp-body">
              Your digital product is very likely not the first one your user
              has encountered. Over time, with exposure to other digital
              products, users form perceptions about how certain types of
              interactions are supposed to work. For the most part a lot of
              expectations users have will be shared with the general
              population, but in the end every person possesses their own set of
              mental models. As an enterprise this presents us with a unique
              opportunity to mold the expectations of our users. We can choose
              to adopt these existing mental models to a degree and use them to
              our advantage. Or, we can choose to buck the trend to make
              something unique. There is a price to pay either way.
            </p>
            ...
            <p className="cbp-body">
              ...
              general web) does not necessarily mean that is appropriate for
              your purposes or that it is indeed the best decision. People get
              used to bad UI all the time. Don't let familiarity necessarily
              equate to superiority. There's really no such thing as a universal
              experience on the web but certain best practices are widely
              accepted. That's why it is so important to have a consistent
              experience across the CBP enterprise. We can build upon existing
              best practices and reinforce our UX choices by repeated exposure
              to our products. This allows us to reduce cognitive load on our
              users by letting them focus on doing their jobs and not waste time
              learning new mental models, except where necessary.
            </p>
            ...
            <p className="cbp-body">
              ...
              they already know. Typically we refer to these common experiences
              as affordances. Users will come to your product expecting similar
            ...
            <p className="cbp-body">
              ...
              the change you make is quite intuitive. Sometimes, in a user's
              first few exposures to this pattern, they may not make an
              immediate connection to what is expected from them. In these
              cases, you pay a cost of added cognitive load in making these
              changes.
            </p>
            <p className="cbp-body">
              ...
              and the new, proposed UI to see if users get confused, lost, or
              make errors based on these changes versus the old user interface.
            </p>
            <p className="cbp-body">
              Another way to manage added cognitive load when changing a
              particular feature is to allow your users to continue to access
              that familiar version while they become accustomed to the new way
              of doing things. For example, you have a page that is heavily laid
              out in large data tables but you are moving towards a card based
              layout. It may be helpful to maintain these two view
              simultaneously for a while. Then get rid of the table view
              provided it wasn't essential and the new view is successful.
            </p>
            ...
            <p className="cbp-body">
              ...
              too long to respond. (learn more about perceived performance in
              the Communications section of foundations here).
            ...
            <div className="content">
              <ul>
                <li>
                  ...
                  The time a user is required to think between the user
                  receiving a complete response to an command and the time the
                  user can enter the next command.
                </li>
                ...
                <li>
                  ...
                  The time between a user giving the system a command and when
                  the system is able to display a complete response.
                </li>
                <figure>
                  <Image
            ...
            <p className="cbp-body">
              ...
              number and complexity of choices. With well thought out
              information architecture and limiting the amount of options to
              what is necessary we can speed up the time it takes our users to
              come to a decision point and increase productivity.
            </p>
            <Image imgName="interactivity-hicksLaw.png" size="700px" />

            <h4 className="cbp-heading-4">When to Apply</h4>
            <p className="cbp-body">
              It is important to apply Hick's Law in a fashion that is relevant
              to the situation the user is presently in. With user workflows the
              inverted pyramid comes into play. At the highest level,
              information is kept to the minimum needed for the user to make a
              choice about where to delve more deeply. As they move down the
              funnel, information gets more specific and options for actions
              increase. The quicker a user needs to make a decision, the fewer
              choices you should be giving to your user. The more deliberation
              needed before taking an action, the less Hick's law applies.
              Though there is still always the possibility of choice fatigue.
            </p>

            <h4 className="cbp-heading-4">
              Helpful Tips in Reducing Complexity
            </h4>
            <div className="content">
              <ul>
                <li>
                ...
                <li>
                  ...
                  response time is critical as it speeds up the time used to
                  make decisions. It's also more likely with fewer options that
                  your user will be able to accomplish their goal and not get
                  lost. People tend to like working on older cars not just
                  because they're attractive looking, but because they're easier
                  to work on. Less moving parts, easier to fix.
                </li>

                <li>
                  Take care not to oversimplify. A user that can't find the
                  appropriate option can get frustrated and give up, or make the
                  wrong decision because the more appropriate one wasn't
                  present.
                </li>
                ...
                <li>
                  ...
                  choose. This should not be applied to actions where the
                  decision can have dire consequences so as to not introduce
                  unwanted bias into that kind of decision-making process.
                </li>
              </ul>
              <Image
                imgName="interactivity-reduceComplexity.png"
                size="700px"
              />
            </div>
            ...
            <p className="cbp-body">
              ...
              there is a certain amount of complexity in a system which cannot
              be reduced. At CBP, most of the systems we build are data rich,
              dense UIs that have very robust capabilities. We need to make sure
              that during the process of abstraction into the simplest terms, we
              don't oversimplify the solution to the point we lose functionality
              or distract from the business purpose for which the system was
              built.
            </p>
            <p className="cbp-body">
              The main choice here is, do we put that choice on our users via
              controls, or do we have the system handle that complexity on
              behalf of the user. With user input, the choices we make about
              handling complexity are mostly about how its presented, what
              instruction is present, and the resulting behavior. When the
              system handles the complexity on behalf of the user, there are a
              lot of assumptions that come into play, hidden controls, etc that
              can become problematic very easily for our users to properly
              understand or follow.
            </p>

            <h3 className="cbp-heading-3">Zeigarnik Effect</h3>
            <p className="cbp-body">
              The Zeigarnik Effect is where users are more able to recall
              actions that are incomplete, rather than complete. The brain tends
              to fixate on tasks left incomplete so you can use this to your
              advantage in long forms by using visual cues to reinforce steps or
              percentage complete.
            </p>
            ...
            <p className="cbp-body">
              ...
              respond to usual or typical members. For example, when asked to
              name a bird an individual is much more likely to respond with
              robin instead of penguin.
            </p>
            ...
            <p className="cbp-body">
              ...
              through these interactive elements. This sequence of moving from
              one interactive element to another must follow logical reading
              order. Normally this means the top-down, left-right reading order
              should be followed, but in general this refers to the reading
              order of the content on the page by hierarchical standards. Some
              mobile-optimized applications may utilize a bottom navigation
              which would put it above any content on the page in reading order
              despite being physically below said content. Use your best
              judgement and imagine the order in which you intend your user to
              interact with this content. That should define your reading order.
              Unfortunately due to the subjectivity of this criteria it can
              never be fully automated. Try and order your elements in the DOM
              to match tab order, rather than using the "tabindex" attribute to
              force elements around as this makes your code increasingly
              fragile.
            </p>
            <div className="content">
              <ol>
                <li>
                  ...
                  preserves meaning and operability only when navigation
                  sequences affect meaning and operability.
                </li>

                <li>
                  In those cases where it is required, there may be more than
                  one order that will preserve meaning and operability.
                </li>
            ...
            <div className="content">
              <ol>
                ...
                <li>
                  The new content may interfere with the user's ability to
                  perform a task.
                </li>

                <li>
                  The new content or functionality may be unavailable to users
                  on other types of devices who may not accept hover as a
            ...
            <p className="cbp-body">
              ...
              must be dismissible, hoverable, and persistent. But really it's
              just easier to make it accessible by another means of interaction
              like an icon which opens/closes with a click/tap.
            </p>
            <p className="cbp-body">
            ...
            <p className="cbp-body">
              ...
              tabbing through content and encounters a grouping of elements
              which, instead of allowing the user to move down the tab order
              correctly, send the user's focus around in circles (a trap). This
              functionally kills all usability for that user on this page. The
              usual culprit here is a plugin or other embedded content.
            </p>

            <h4 className="cbp-heading-4">Skip Links</h4>
            <p className="cbp-body">
              It is common practice for web-based digital products to have a
              "skip link" as the very first element in the page. This allow
              users to skip repetitive content like navigation and go straight
              to the main content part of the page. Usually the first tab a user
              activates focuses on this "hidden" control. Skip links are usually
              hidden until focused. If the user selects the link, focus will be
              moved to the main content area of the page. If they move focus
              beyond the skip link, assistive technology will begin with the
              first element on the page (most likely navigation). This should
              always be the first item in your tab order.
            </p>

            <h4 className="cbp-heading-4">Hover/Focus States</h4>
            <p className="cbp-body">
              All interactive elements should have a treatment consistent with
              the CBP Design System to visually identify its appearance during a
              hover or focus state (they should appear identically).
            </p>
            ...
            <p className="cbp-body">
              ...
              system receives should be flexible. Some users will have a hard
              time drawing a straight line when using a component like a slider.
              If they go a little vertical the system should still respond
              according to the general direction of input. Pinch to zoom
              shouldn't matter in what direction your fingers are going as long
              as they are going closer or farther from each other.
            </p>
            <p className="cbp-body">
              Users may also inadvertently click or tap elements so we need a
              way to cancel these actions. The most common way to do so is to
              not accept that input until the "up event" is accepted. For
              example, if you tap a button by accident and while your finger is
              still pressed you move your finger off the button target area.
              Upon lifting your finger the action is not taken.
            </p>

            <h4 className="cbp-heading-4">Touch Target Size</h4>
            <p className="cbp-body">
              All interactive elements should have a touch target area of at
              least 48px by 48px. The WCAG standard is 44px but the
              well-documented Google rationale for 48px is more compelling.
              Plus, this exceeds the required standard.
            </p>
            ...
            <p className="cbp-body">
              Similar interactive elements should behave similarly. Buttons
              should behave in a cohesive way no matter what part of the product
              you are in, same as text input fields, or any other element. There
              should be sufficient cues to the user when they should expect a
              common UI element will not behave in a way that is familiar. For
              example hitting the back button on a form may trigger a warning
              dialogue modal that tells the user they may lose unsaved work.
            </p>
            <p className="cbp-body">
              Interactive elements that have identical functionality should have
              the same accessible name. Having two text fields that are
              addresses but with completely different names would be confusing
              and add cognitive load to your users.
            </p>

            {/* @TODO: Insert Success Criterion stuff here if required */}

            <h3 className="cbp-heading-3">
              Interactive Element Styling Issues
            </h3>
            <p className="cbp-body">
              Using only color, shape, size, visual location, orientation, or
              sound to provide the sole means of understanding and operating
              content on your page is problematic as it can either alienate
              those with a visual acuity disorder (color, shape, size, location,
              orientation) or those with a hearing disorder (sounds). Think
              about how to incorporate cues that might close the gap so that
              each type of user can understand your content. Giving instruction
              to your user that "fields labeled in red are required" would not
              be sufficient without also giving another means of indicating the
              field is required like adding a symbol, changing text styles, or
              labeling each individual field with the word required.
            </p>

            <h4 className="cbp-heading-4">Sensory Instruction</h4>
            <p className="cbp-body">
              In your instruction to users, do not rely on wording that would
              only apply to users with full use of a particular sense such as
              sight or hearing. All of the above can be tricky thing for someone
              who is blind. Try to be more precise with your language or give
              alternative instruction that might be picked up by assistive
              technology to explain what you mean in a way your users can
              understand.
            </p>
            ...
            <p className="cbp-body">
              ...
              semantically coded one, it complicates matters more than it's
              worth to have a specific styling.
            </p>
            {/* @TODO: Insert Success Criterion stuff here if required */}
            ...
            <p className="cbp-body">
              ...
              user can readily identify what the intended purpose of the field
              is. Visible labels and appropriate instruction help us understand
              the function of different input fields. Programmatically
              identifying the input type by category for example, input
              type="tel", input type="email", or input type="password" can help
              give users with assistive technology cues to an input's purpose or
              intended format when paired with a robust label and instruction.
              Where inputs have a label visually next to it, it must also match
              its programmatic label.
            </p>

            <h4 className="cbp-heading-4">Keyboard Accessible</h4>
            <p className="cbp-body">
              All interactive elements should be accessible by using a keyboard
              without needing to do specific key combinations in a certain
              amount of time. Examples of "specific timings for individual
              keystrokes" include situations where a user would be required to
              repeat or execute multiple keystrokes within a short period of
              time or where a key must be held down for an extended period
              before the keystroke is registered. Some types of interaction will
              never be able to be replicated with a keyboard like freehand
              drawing and some gaming, and those elements are exempt. There are
              common key commands associated with certain types of interactions
              such as the tab key allowing users to move down the tab order from
              one interactive element to the next. Where your UI requires a
              non-standard key command, you need to provide appropriate helper
              text to explain its function. These keyboard shortcuts need to
              have the option for the user to disable these functions as well.
              Users who access your product via voice may become frustrated as
              saying a single letter character out loud has the unintended
              effect of activating a shortcut.
            </p>

            <h4 className="cbp-heading-4">Link Purpose</h4>
            <p className="cbp-body">
              Your users should be able to understand where a link is taking
              them either by the text in the link, the link is contained by text
              giving contextual clues, or programmatically by the title
              attribute. The title for each link also must be unique. Screen
              reader users will not have the visual cues at their disposal to
              navigate the meaning of 5 instances of "Learn More" links on a
              page. Developers need to be more descriptive here. For instances
              where links are opening documents, books, or articles the title of
              said product is sufficient. The CBP Design System also utilizes
              the icon (external-link-alt) to designate a link that will lead
              the user outside of their current application and should be
              applied to all said links.
            </p>
            ...
            <p className="cbp-body">
              When the system changes content based on user input and this
              change does not receive user focus, such as a status message,
              there is a way to identify this change with the role attribute.
              For example as the system returns 5 results after a search is
              conducted. At the top of the results, the message 5 results found
              is clearly visible.
            </p>
            {/* @TODO: Insert Success Criterion stuff here if required */}
          </section>
